    ...
    return (
      <div className="flex items-center gap-2">
        <input
          ...
          id={radioId}
          className={cn(
            "h-4 w-4 rounded-full border bg-white text-primary transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
            hasError
